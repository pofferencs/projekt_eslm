...
function Footer() {
  return (
    <footer className="footer sm:footer-horizontal bg-base-200 text-base-content p-10 mt-auto flex flex-col gap-8">
      ...
      <div className="w-full flex justify-center text-sm text-base-content pt-4 border-t">
        <p className="text-center">
          Copyright © 2025 Gedovics Krisztián™ |-| Korcsok Roland™. Minden jog fenntartva. All rights reserved.
        </p>
      </div>
