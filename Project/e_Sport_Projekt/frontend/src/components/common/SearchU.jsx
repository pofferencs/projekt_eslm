    ...
    return (
        <div>
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form onSubmit={kereses}>
                    <label htmlFor="username" className="block text-sm/6 font-medium text-indigo-600">Felhasználónév</label>

                    <div className="mt-2">
                        <input type="text" name="username" id="username" autoComplete="username" required className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                    </div>
                    <div>
