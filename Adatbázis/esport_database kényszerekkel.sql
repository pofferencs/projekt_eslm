...
CREATE TABLE Matches(
	...
	tnt_id int NOT NULL,
	CONSTRAINT FK_Tem1_Mah FOREIGN KEY (tem1_id) REFERENCES Teams(id) ON DELETE RESTRICT,
	CONSTRAINT FK_Tem2_Mah FOREIGN KEY (tem2_id) REFERENCES Teams(id) ON DELETE RESTRICT,
